...
def get_clip_embeddings(model, dataloader, args, 
    ...
    args.embeddings_dir = os.path.join(args.embeddings_dir, args.dataset) 
...
def evaluate_clip(clip_predictions, target, group, verbose=False):
    """
    ...
    avg_acc, robust_acc, groups_acc = summarize_acc(correct_by_groups,
                                        total_by_groups,return_groups=True,
                                        stdout=verbose)
